...
public class MobileUI : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        // WebGL: só mostra botões se a tela for touch de verdade (celular/tablet)
        // No PC o jogador usa teclado normalmente
    }
    ...
    void OnGUI()
    {
        // Mostra controles mobile em mobile/WebGL, OU se forçado
        bool mostrar = isMobile && GameManager.instance != null && GameManager.instance.JogoRodando();
        if (!mostrar) return;
    ...
    void CalcularRects(out Rect rEsq, out Rect rDir, out Rect rAtira)
    {
        ...
        // Tamanho base: 18% da menor dimensão (funciona em portrait e landscape)
        ...
        // Direita — ao lado da esquerda
        rDir = new Rect(margem + btnSize + margem * 0.6f, baseY, btnSize, btnSize);
